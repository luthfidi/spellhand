...
export const LETTERS: LetterMeta[] = [
  ...
  { code: "M", index: 12, nato: "Mike",     level: 3, implemented: true,
  ...
  { code: "P", index: 15, nato: "Papa",     level: 4, implemented: true,
  ...
  { code: "S", index: 18, nato: "Sierra",   level: 2, implemented: true,
  ...
  { code: "T", index: 19, nato: "Tango",    level: 2, implemented: true,
  ...
  { code: "X", index: 23, nato: "X-Ray",    level: 3, implemented: true,
